...
OpticSim.jl is a [Julia](https://julialang.org/) geometric optics (ray tracing) package for simulation and optimization of complex optical systems developed by the Microsoft Research Interactive Media Group and the Microsoft HART group.
